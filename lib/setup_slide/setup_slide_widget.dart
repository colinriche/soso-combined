...
import 'setup_slide_model.dart';
export 'setup_slide_model.dart';

class SetupSlideWidget extends StatefulWidget {
  const SetupSlideWidget({Key? key}) : super(key: key);

  @override
  _SetupSlideWidgetState createState() => _SetupSlideWidgetState();
}

class _SetupSlideWidgetState extends State<SetupSlideWidget> {
  late SetupSlideModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SetupSlideModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> setupSlideUsersRecordList = snapshot.data!;
        final setupSlideUsersRecord = setupSlideUsersRecordList.isNotEmpty
            ? setupSlideUsersRecordList.first
            : null;
        return Title(
            title: 'Setup-slide',
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            value: _model.parkingSpaceValue ??=
                                                                                setupSlideUsersRecord!.homeLeased,
                                                                            onChanged:
                                                                                (newValue) async {
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                CheckboxListTile(
                                                                              value: _model.parkingPermitValue ??= setupSlideUsersRecord!.parkingPermit,
