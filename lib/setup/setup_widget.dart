  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> setupUsersRecordList = snapshot.data!;
        final setupUsersRecord =
            setupUsersRecordList.isNotEmpty ? setupUsersRecordList.first : null;
        return Title(
            title: 'Setup',
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          onChanged: (_) =>
                                            ...
                                            () async {
                                              setState(() {
                                                _model.plate1 = _model
                                                    .plate1InputController.text;
                                              });
                                            },
                                          ),
                                          textCapitalization:
                                      ...
                                      Theme(
                                        ...
                                        child: CheckboxListTile(
                                          ...
                                          subtitle: Text(
                                            'This vehicle is owned by me or another - No commercial use',
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium,
                                          ),
                                          tileColor:
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          onChanged: (_) =>
                                            ...
                                            () async {
                                              setState(() {
                                                _model.plate2 = _model
                                                    .plate2InputController.text;
                                              });
                                            },
                                          ),
                                          textCapitalization:
