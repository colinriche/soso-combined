...
import 'driving_copy_model.dart';
export 'driving_copy_model.dart';

class DrivingCopyWidget extends StatefulWidget {
   DrivingCopyWidget({Key? key}) : super(key: key);


  @override
  _DrivingCopyWidgetState createState() => _DrivingCopyWidgetState();
}

class _DrivingCopyWidgetState extends State<DrivingCopyWidget> {
  late DrivingCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DrivingCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<LogsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<LogsRecord> drivingCopyLogsRecordList = snapshot.data!;
        return Title(
            title: 'DrivingCopy',
                ...
                children: [
                      ...
                      child: Column(
                        ...
                        children: [
                                    ...
                                    child: StreamBuilder<Activity>(
                                      ...
                                      builder: (context, snapshot) {
                                        if (snapshot.hasData) {
                                          ...
                                          int speedInMphInteger = speedInMph.toInt();
                                          return Text(
                                            speedInMphInteger.toString(),
                          ...
                          StreamBuilder<LogsRecord>(
                            stream:
                                LogsRecord.getDocument(drivingCopyLogsRecordList
                                    .take(1)
                                    .toList()
                  ...
                  Align(
                    ...
                    child: wrapWithModel(
                      ...
                      child: const CustomNavBarSettingsWidget(
                        hidden: false,
                      ),
                    ),
                  ),
